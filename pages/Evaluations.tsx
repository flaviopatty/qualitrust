  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm transition-all">
        <div className="p-4 border-b border-slate-100 flex flex-col lg:flex-row gap-4 justify-between lg:items-center bg-slate-50/50">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full lg:w-auto">
            <select className="w-full sm:w-auto text-sm bg-white border border-slate-200 rounded-lg py-2 pl-3 pr-10 focus:ring-primary focus:border-primary">
          ...
          <table className="w-full text-left min-w-[800px] lg:min-w-full">
            <thead>
              <tr className="bg-slate-50 text-slate-500 text-xs font-semibold uppercase tracking-wider">
                ...
                <th className="px-6 py-4 hidden md:table-cell">Tipo de Serviço</th>
